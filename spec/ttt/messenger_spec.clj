...
(describe "result"
  (context ":default"
    (let [game (game/create-game :human :human)]
  ...
  (context ":computer-x-human"
    (let [game (game/create-game :human :easy-computer)
...
(describe "moved-to"
  (let [human (player/make-player { :marker :x :role :human })
        easy-computer (player/make-player { :marker :o :role :easy-computer })
        hard-computer (player/make-player { :marker :h :role :hard-computer })
        human-x-human (game/create-game :human :human)
        easy-x-human (game/create-game :easy-computer :human)
        easy-x-easy (game/create-game :easy-computer :easy-computer)
        hard-x-human (game/create-game :hard-computer :human)
        hard-x-hard (game/create-game :hard-computer :hard-computer)]
    (context ":computer-x-human"
